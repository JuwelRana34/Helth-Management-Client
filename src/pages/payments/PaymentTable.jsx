...
const PaymentTable = () => {
  ...
  return (
    <div className="container mx-auto ">
      <h2 className="text-2xl font-semibold dark:text-darkText mb-4">Payment History</h2>
      {loading ? (
        <p className="text-center text-gray-600">Loading payments...</p>
      ) : (
        <div className="overflow-x-auto">
          <table className="min-w-full min-h-40 bg-white   dark:bg-dark  shadow-md rounded-lg relative">
            <thead>
              <tr className="bg-gray-200 text-gray-600 uppercase dark:text-darkText dark:bg-dark  text-sm leading-normal">
            ...
            <tbody className="text-gray-700 dark:text-darkText  text-sm font-light relative">
            {payments.length === 0 ?<>
