...
const MarqueeSection = () => {
  ...
  return (
    <div className={` bg-primary dark:bg-dark py-6  text-white`}>
        ...
        <div className="w-full lg:flex-1 overflow-x-auto scrollbar-thin scrollbar-thumb-teal-400">
          <Marquee gradient={false} speed={50}>
            {sponsors.map((sponsor, index) => (
              <div
                key={index}
                className="flex items-center space-x-3 px-4 py-2 mx-2 bg-emerald-600 dark:bg-slate-800 rounded-md shadow-md"
              >
                {sponsor.logo}
